    ...
    <div class="col-12 col-xl-8">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Dados da Lead</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('leads.store') }}" method="POST">
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-6">
                            ...
                            <select name="type" id="type" class="form-select @error('type') is-invalid @enderror" required>
                                ...
                                @foreach(\App\Models\Lead::types() as $value => $label)
                                    <option value="{{ $value }}" {{ old('type', request('type')) == $value ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @error('type')
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <select name="status" id="status" class="form-select @error('status') is-invalid @enderror" required>
                                @foreach(\App\Models\Lead::statuses() as $value => $label)
                                    <option value="{{ $value }}" {{ old('status', request('status', 'por_tratar')) == $value ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="email@exemplo.com" value="{{ old('email') }}">
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <select name="origin" id="origin" class="form-select @error('origin') is-invalid @enderror" required>
                                ...
                                @foreach(\App\Models\Lead::origins() as $value => $label)
                                    <option value="{{ $value }}" {{ old('origin') == $value ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @error('origin')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" name="property_reference" id="property_reference" class="form-control @error('property_reference') is-invalid @enderror" placeholder="Ex: REF-001" value="{{ old('property_reference') }}">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="notes" id="notes" rows="3" class="form-control @error('notes') is-invalid @enderror" placeholder="Observações sobre a lead...">{{ old('notes') }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    @php
                        $preference = null; // Para o partial funcionar
                    @endphp
                    @include('leads.partials.preference-form')

                    <div class="mt-4 d-flex gap-2 justify-content-end">
                        <a href="{{ route('leads.index') }}" class="btn btn-light">Cancelar</a>
