                                                    ...
                                                    <li class="list-group-item p-0 border-start-0 border-end-0">
                                                        ...
                                                        >
                                                            <span class="booking-row__text">
                                                                ...
                                                                <span class="booking-row__duration">{{ $service->formatted_duration }}</span>
                                                            ...
                                                            <span class="booking-row__aside">
                                                                <span class="booking-row__price">{{ number_format((float) $price, 2, ',', '.') }}&nbsp;€</span>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow rounded-3">
                <div class="modal-header border-0 pb-0">
                    <h2 class="modal-title h5 fw-semibold" id="bookingModalTitle">Adicionar à marcação?</h2>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
                </div>
                <div class="modal-body pt-2">
                    <p id="booking-modal-service-name" class="fw-medium mb-1"></p>
                    <p id="booking-modal-service-meta" class="text-muted small mb-0"></p>
                </div>
                <div class="modal-footer border-0 pt-0">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Cancelar</button>
                    <button type="button" class="btn btn-dark" id="booking-modal-confirm">Adicionar à marcação</button>
                </div>
            </div>
        </div>
    </div>
