    ...
    <div class="card-body">
        <div class="uedit-section">
            ...
            <p class="text-muted small mb-3">
                Indica em que dias e horas este membro está disponível para marcações. Na agenda, este horário cruza-se com o da loja ({{ $storeHoursLabel ?? 'ver Definições → Loja' }}): fora desta janela o tempo aparece com riscas a cinzento; pode marcar na mesma, com aviso.
            </p>
