                    ...
                    <div class="uedit-section">
                        ...
                        <div class="row">
                            ...
                            @include('agentes.partials.specialization-field', [
                                'currentRole' => old('role', $agente->user->role ?? 'prestador'),
                                'specializationValue' => old('specialization', $agente->specialization),
                            ])
                            @include('agentes.partials.commission-field', [
                                'commissionRate' => old('commission_rate', $agente->commission_rate),
                                'commissionUnit' => old('commission_unit', $agente->commission_unit ?? \App\Models\Agent::COMMISSION_UNIT_PERCENT),
                            ])
                        </div>
                    </div>
                </div>
                    ...
                    <div class="uedit-section">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="birth_date" class="form-control @error('birth_date') is-invalid @enderror" value="{{ old('birth_date', $agente->birth_date?->format('Y-m-d')) }}" data-crm-datepicker data-max-date="{{ date('Y-m-d', strtotime('-18 years')) }}" autocomplete="off" placeholder="dd/mm/aaaa">
                                @error('birth_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
