...
@section('title', 'Novo Imóvel | Imobiliária')
@section('page-heading-title', 'Novo Imóvel')
            ...
            <div class="card-body">
                <form action="{{ route('properties.store') }}" method="POST">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <select name="property_condition_id" id="property_condition_id" class="form-select @error('property_condition_id') is-invalid @enderror">
                                        ...
                                        @foreach($propertyConditions as $condition)
                                            <option value="{{ $condition->id }}" {{ old('property_condition_id') == $condition->id ? 'selected' : '' }}>{{ $condition->name }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="tab-pane fade" id="negocio" role="tabpanel">
                            <div class="row g-3">
                                <div class="col-12 col-md-6">
                                    ...
                                    <select name="transaction_type_id" id="transaction_type_id" class="form-select @error('transaction_type_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($transactionTypes as $id => $name)
                                            <option value="{{ $id }}" {{ old('transaction_type_id') == $id ? 'selected' : '' }}>{{ $name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="number" name="condominium_fee" id="condominium_fee" step="0.01" class="form-control @error('condominium_fee') is-invalid @enderror" value="{{ old('condominium_fee') }}">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="number" name="imi_value" id="imi_value" step="0.01" class="form-control @error('imi_value') is-invalid @enderror" value="{{ old('imi_value') }}">
                                    @error('imi_value')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="number" name="commission_percentage" id="commission_percentage" step="0.01" class="form-control @error('commission_percentage') is-invalid @enderror" value="{{ old('commission_percentage') }}">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="number" name="commission_value" id="commission_value" step="0.01" class="form-control @error('commission_value') is-invalid @enderror" value="{{ old('commission_value') }}" readonly>
                        ...
                        <div class="tab-pane fade" id="localizacao" role="tabpanel">
                            <div class="row g-3">
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="text" name="country" id="country" class="form-control @error('country') is-invalid @enderror" value="{{ old('country', 'Portugal') }}">
                                    @error('country')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <input type="text" name="floor_address" id="floor_address" class="form-control @error('floor_address') is-invalid @enderror" placeholder="Ex: 2º" value="{{ old('floor_address') }}" maxlength="10">
                                    @error('floor_address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <input type="number" name="latitude" id="latitude" step="0.00000001" class="form-control @error('latitude') is-invalid @enderror" value="{{ old('latitude') }}">
                                    @error('latitude')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-12 col-md-3">
                                    ...
                                    <input type="number" name="longitude" id="longitude" step="0.00000001" class="form-control @error('longitude') is-invalid @enderror" value="{{ old('longitude') }}">
                                    @error('longitude')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="tab-pane fade" id="caracteristicas" role="tabpanel">
                            <div class="row g-3">
                                <div class="col-12 col-md-6">
                                    ...
                                    <select name="property_typology_id" id="property_typology_id" class="form-select @error('property_typology_id') is-invalid @enderror">
                                        ...
                                        @foreach($propertyTypologies as $typology)
                                            <option value="{{ $typology->id }}" {{ old('property_typology_id') == $typology->id ? 'selected' : '' }}>{{ $typology->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <select name="energy_certificate" id="energy_certificate" class="form-select @error('energy_certificate') is-invalid @enderror">
                                        ...
                                        @foreach($energyCertificates as $value => $label)
                                            <option value="{{ $value }}" {{ old('energy_certificate') == $value ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="number" name="area_total" id="area_total" step="0.01" class="form-control @error('area_total') is-invalid @enderror" value="{{ old('area_total') }}">
                                    @error('area_total')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="number" name="area_private" id="area_private" step="0.01" class="form-control @error('area_private') is-invalid @enderror" value="{{ old('area_private') }}">
                                    @error('area_private')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-12 col-md-3">
                                    ...
                                    <input type="number" name="bathrooms" id="bathrooms" min="0" class="form-control @error('bathrooms') is-invalid @enderror" value="{{ old('bathrooms') }}">
                                    @error('bathrooms')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-12 col-md-3">
                                    ...
                                    <input type="number" name="garages" id="garages" min="0" class="form-control @error('garages') is-invalid @enderror" value="{{ old('garages') }}">
                                    @error('garages')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-12 col-md-3">
                                    ...
                                    <input type="number" name="parking_spaces" id="parking_spaces" min="0" class="form-control @error('parking_spaces') is-invalid @enderror" value="{{ old('parking_spaces') }}">
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <input type="number" name="floor" id="floor" class="form-control @error('floor') is-invalid @enderror" value="{{ old('floor') }}">
                                    @error('floor')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="number" name="year_built" id="year_built" min="1000" max="{{ date('Y') + 1 }}" class="form-control @error('year_built') is-invalid @enderror" value="{{ old('year_built') }}">
                                    @error('year_built')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                        ...
                                        @foreach($propertyFeatures as $feature)
                                            <div class="col-12 col-md-3 mb-2">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" name="features[]" id="feature_{{ $feature->id }}" value="{{ $feature->id }}" {{ in_array($feature->id, old('features', [])) ? 'checked' : '' }}>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <select name="orientation" id="orientation" class="form-select @error('orientation') is-invalid @enderror">
                                        ...
                                        @foreach($orientations as $value => $label)
                                            <option value="{{ $value }}" {{ old('orientation') == $value ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                                    </select>
                                    @error('orientation')
                                        <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="mt-4 d-flex gap-2 justify-content-end">
                        <a href="{{ route('properties.index') }}" class="btn btn-light">Cancelar</a>
